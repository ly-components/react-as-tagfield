...
/******/ 	var hotCurrentHash = "6d206eda20d04bf18d85"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AsForm = (function (_React$Component) {
	    ...
	    this.render = function () {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          null,
	          _react2['default'].createElement(_srcIndex2['default'], { ref: 'tags', placeholder: '输入新标签', onChange: _this.handleTagChange, initTags: ['JavaScript', 'CSS', 'HTML'] })
	        ),
	        _react2['default'].createElement(
	          'div',
	          null,
	  ...
	  _inherits(AsForm, _React$Component);

	  return AsForm;
	})(_react2['default'].Component);

	_react2['default'].render(_react2['default'].createElement(AsForm, null), document.getElementById('tagField'));
		...
		function AsTagField(props) {
			...
			this.render = function () {
				...
				return _react2['default'].createElement(
					...
					$tags,
					_react2['default'].createElement('input', { className: 'as-tags-input', placeholder: _this.props.placeholder, type: 'text' })
				);
			};
